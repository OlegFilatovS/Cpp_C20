...
Rect::Rect(int left, int right, int top, int bottom) :Shape(Red)
{
...
Rect::~Rect() {
	//__asm nop
	std::cout << "Im Rect desructor" << std::endl;
...
void Rect::WhereAmI() const {
	...
	std::cout << "Im in Rect class" << std::endl;
